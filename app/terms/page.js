      ...
      <main className="max-w-3xl mx-auto px-4 pb-16">
        <div className="bg-white p-6 sm:p-8 rounded-xl shadow-md border border-slate-100 space-y-6 text-sm leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <p>
              For California, Texas, Florida, Ohio, and most New York notice types, the statutory citation,
              notice period, and day-counting deadline in your notice are computed from a researched, sourced
              rules table, not generated by the AI from scratch. The one exception is New York&apos;s &quot;Cure
              or Quit&quot; notice, which has no statewide statute of general applicability behind it — that
              specific notice type is currently drafted by the AI using general legal research and has not been
              independently statute-verified the same way (the wizard discloses this before you generate it). In
              all cases, laws change and every situation is different — you should independently verify any
